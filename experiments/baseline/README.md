...
- 40-step full baseline: SUCCESS 2026-09-23. 1024 RGBA teapot, visibly sharper (lid knob, glaze speckle), sha `692bc32c247519a8`. load 1.6s, gen 2434.3s, 60.86s/step (text-encode amortized + MPS warmup). See `smoke_s40.json`.
